    ...
    <script type="text/javascript">
        var main = function () {
            ...
            function sendStopMsg() {
                $.ajax({
                    url: 'http://server-erp2.sma.gov.jm:8080/integrationservice.asmx/SendMessage',
                    type: 'POST',
            ...
            function getUserCount() {
                $.ajax({
                    url: 'http://server-erp2.sma.gov.jm:8080/integrationservice.asmx/GetUserCount',
                    type: 'POST',
                    contentType: 'application/json',
                    data: {},
                    dataType: 'json',
            ...
            function GetLogMessages() {
                $.ajax({
                    url: 'http://server-erp2.sma.gov.jm:8080/IntegrationService.asmx/GetLog',
                    type: 'post',
                    contentType: 'application/json',
                    data: {},
                    dataType: 'json',
