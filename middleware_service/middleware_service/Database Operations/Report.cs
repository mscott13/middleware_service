...
namespace middleware_service.Database_Operations
{
    class Report
    {
        private string pdfImgPath = @"C:\Users\mscott\Desktop\Git Repositories\middleware_service\middleware_service\middleware_service\resources\spec.jpg";
        private string pdfFilePath = @"C:\Users\mscott\Desktop\Git Repositories\middleware_service\middleware_service\middleware_service\resources\reports\";
        ...
        {
            string path_local = pdfFilePath + ReportType + "DefferedIncomeSummaryReport" + startDate.Year.ToString() + startDate.Month.ToString("00") + "01.pdf";
