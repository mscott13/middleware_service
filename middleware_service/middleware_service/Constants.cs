namespace middleware_service
{
    public static class Constants
    {
        ...
        public const string DB_GENERIC = @"Data Source=SERVER-ERP2\ASMSDEV;Initial Catalog=" + DB_GENERIC_NAME + ";Integrated Security=True; MultipleActiveResultSets=true; Connection Timeout=30; Min Pool Size=5";
        public const string DB_INTEGRATION = @"Data Source=SERVER-ERP2\ASMSDEV;Initial Catalog=" + DB_INTEGRATION_NAME+ ";Integrated Security=True; MultipleActiveResultSets=true; Connection Timeout=30; Min Pool Size=5";
